...
// Para solucionar problema de ver el api en local con docker y servidor de pre y pro

// 1- ejecutar "php artisan vendor:publish --tag=request-docs-assets"
// 2- Reemplazar en el código todas las apariciones de "/request-docs/" por "/api/request-docs/"
// 3- Acceder a la url http://localhost:8080/api/request-docs
